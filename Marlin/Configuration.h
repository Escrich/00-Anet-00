...
#define STRING_CONFIG_H_AUTHOR "(Escrich, AnetET4)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Escrich AnetET4"
 ...
 *
 */
#define TEMP_SENSOR_0 1 // Before it was 504
...
#define TEMP_SENSOR_BED 1 // Before it was 505
...
#define PIDTEMP // See the PID Tuning Guide at https://reprap.org/wiki/PID_Tuning  -----------------------PID  AnetET4
...
#else
// AnetET4 Autotune PID results real ones ------------- 20221103
...
#define MPC_HEATER_POWER \
  {                      \
    50.0f                \
  } // (W) Heat cartridge powers.  -------------------------------------------------------------- AnetET4
...
#if ENABLED(MPC_INCLUDE_FAN) //  -------------------------------------------------------------------- AnetET4
...
// Valores definidos por mi para mi AnetET4  -- Escrich, Real ones ------------- 20221103
...
#define USE_XMIN_PLUG // AnetET4                                                             Ok to install BLtouch on Anet
...
#define DEFAULT_AXIS_STEPS_PER_UNIT              \
  {                                              \
    80, 80, 400, 94.75 \
  } // ------------------------ Cambiados valores calculados AnetET4, anteriores 80, 80, 1600, 95
...
#define DEFAULT_MAX_FEEDRATE \
  {                          \
    300, 300, 9, 180         \
  } // Ajustadas conforme a Hypothetic  ////////--------------- Atención 50% mas de velocidad en AnetET4-------- antes 200, 200, 12, 120 ----------------
...
#define DEFAULT_MAX_ACCELERATION \
  {                              \
    1000, 1000, 100, 5000        \
  } // Ajustadas conforme a Hypothetic
 ...
 */
#define CLASSIC_JERK // Ajustado 20220428 No compatible con linear advance si es menor de 10
 ...
 */
//#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN            //     Must be active to use BLTouch on Anet

// Force the use of the probe for Z-axis homing
#define USE_PROBE_FOR_Z_HOMING //     Must be active to use BLTouch on Anet  // AnetET4 Conectado para eliminar el switch
...
/*       -----------------------------   Changes to use BLTouch on Anet --------------------------------
...
#define Z_MIN_PROBE_PIN PC3 // PC3 es el inductivo en Anet AnetET4
...
//    ----------------------------------------------- Localización sonda AnetET4, ojo a la altura ----------------------------
...
// Require minimum nozzle and/or bed temperature for probing
 #define PREHEAT_BEFORE_PROBING  //  ----------- Desactivado por el momento, Ya activado, solo se desactiva apra pruebas, AnetET4 -----------------
#if ENABLED(PREHEAT_BEFORE_PROBING)
#define PROBING_NOZZLE_TEMP 190 // (°C) Only applies to E0 at this time, Temperatura suficiente apra fundier el filamento, 190 °C
...
#define X_MIN_POS -2 //  ------------------- Medidos en maquina ----------------------
#define Y_MIN_POS -3
#define Z_MIN_POS 0
#define X_MAX_POS (X_BED_SIZE + 15) // ------------ Limite total de X AnetET4, añadiendo 15 mm. de margen a la derecha
...
//#define AUTO_BED_LEVELING_UBL // fabulosa, pero ha de definirse a mano
 ...
 */
//#define PREHEAT_BEFORE_LEVELING  // no activar, ya está activado PREHEAT_BEFORE_PROBING
...
#define XY_DIAG_AC 311.126983722081
#define XY_DIAG_BD 311.126983722081
#define XY_SIDE_AD 220
...
#define XZ_DIAG_AC 311.126983722081
#define XZ_DIAG_BD 311.126983722081
#define YZ_DIAG_AC 311.126983722081
#define YZ_DIAG_BD 311.126983722081
#define YZ_SIDE_AD 220
...
#define NOZZLE_PARK_POINT                \
  ...
  }                                 //  ------------- Posición de aparcamiento AnetET4
...
//
// 320x240, 2.8", FSMC Stock Display from ET4 ----------- Display original Anet ET4
//
#define ANET_ET4_TFT28

//#if ENABLED(ANET_ET4_TFT28) // Added by me to have remaining time on AnetET4 display, doesn't work
//#define U8GLIB_SH1106
//#endif
