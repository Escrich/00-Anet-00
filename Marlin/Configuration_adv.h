...
//#define EXTRUDER_RUNOUT_PREVENT // No activar, incompatible con ADVANCED_PAUSE_FEATURE
 ...
 */
#define E0_AUTO_FAN_PIN FAN1_PIN // PE1 // FAN1_PIN // Escrich Extruder cooling  -------------------------------------------- Ventiladores
 ...
 */
#define DEFAULT_STEPPER_DEACTIVE_TIME 180 // --------------------------------------AnetET4
...
// The true location and dimension the cube/bolt/washer on the bed.
  #define CALIBRATION_OBJECT_CENTER     { 117.5, 117.5,  0.0 } // mm                  //{ 200.0, -22.0,  -2.0 } // mm
  #define CALIBRATION_OBJECT_DIMENSIONS {  30.0,  30.0,  0.0 } // mm     
 ...
 */
//#define PWM_MOTOR_CURRENT { 800, 800, 420, 420, 600 }           // Values in milliamps
...
#define POWER_LOSS_PIN         -1 // 44 originally Pin to detect power loss. Set to -1 to disable default pin on boards without module. AnetET4 Power
...
#define POWER_LOSS_MIN_Z_CHANGE 0.02 // (mm) Minimum Z change before saving power-loss data ----------------- AnetET4
 ...
 */
#define G29_RETRY_AND_RECOVER  // --------------------- Needs to be changed to define UBL instead of BILINEAR
 ...
 */
//#define DIRECT_STEPPING // Incompatible con Linear_adv  Escrich
 ...
 */
#define NO_WORKSPACE_OFFSETS // --------------------------- ojo
 ...
 */
#define HOST_ACTION_COMMANDS // ---------------------------------------------------------------------------- Nora
#if ENABLED(HOST_ACTION_COMMANDS)
#define HOST_PAUSE_M76      // Tell the host to pause in response to M76
#define HOST_PROMPT_SUPPORT // Initiate host prompts to get user feedback
#if ENABLED(HOST_PROMPT_SUPPORT)
#define HOST_STATUS_NOTIFICATIONS // Send some status messages to the host as notifications  ---------------- Nora
#endif
...
#define COLOR_SELECTION_BG COLOR_GREEN // COLOR_ORANGE2
#define COLOR_COLD COLOR_CYAN          // COLOR_WHITE
...
#define COLOR_AXIS_HOMED COLOR_GREEN    // COLOR_ORANGE2
#define COLOR_AXIS_NOT_HOMED COLOR_RED2 // COLOR_ORANGE2
#define COLOR_RATE_100 COLOR_LIME2
#define COLOR_RATE_ALTERED COLOR_ORANGE2 // COLOR_ORANGE2
#define COLOR_PRINT_TIME COLOR_WHITE
#define COLOR_PROGRESS_BAR COLOR_ORANGE2       // COLOR_ORANGE2
#define COLOR_STATUS_MESSAGE COLOR_VIVID_GREEN // COLOR_ORANGE2
...
#define COLOR_MENU_VALUE_FONT COLOR_VIVID_GREEN // COLOR_ORANGE2
#define COLOR_SLIDER COLOR_VIVID_GREEN          // COLOR_ORANGE2
